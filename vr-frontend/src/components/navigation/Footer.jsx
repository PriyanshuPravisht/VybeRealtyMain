  ...
  return (
    <footer className="footer">
        ...
        <div className="footer__left">
          <div className="footer__inner">
            ...
            <h4 className="footer__heading">
              Neo Realty | Redefining Luxury Real Estate
            </h4>
            <p className="footer__desc">
              As a boutique brokerage, Neo Realty delivers a seamless,
              ...
              ensuring every transaction is effortless and rewarding.hhhhhhii
            </p>
            <p className="footer__desc">
              Your vision. Our expertise. Welcome to Neo Realty.
            </p>
          </div>
        </div>
      ...
      <div className="footer__bottom">
        <p>
          Neo Realty Real Estate Broker LLC is a company registered in Dubai,
